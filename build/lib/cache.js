...
var CacheTransport = function (_Transport) {
    ...
    function CacheTransport() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CacheTransport.__proto__ || Object.getPrototypeOf(CacheTransport)).call.apply(_ref, [this].concat(args))), _this), _this.cache = [], _this.cacheLimit = 1000, _temp), _possibleConstructorReturn(_this, _ret);
    }
